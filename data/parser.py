...
parser_user.add_argument('job', required=True)
parser_user.add_argument('team_leader', required=True, type=int)
parser_user.add_argument('work_size', required=True, type=int)
parser_user.add_argument('collaborators', required=True)
parser_user.add_argument('start_date', required=True)
parser_user.add_argument('end_date', required=True)
parser_user.add_argument('is_finished', required=True, type=bool)